...
import com.arioclub.android.sdk.games.CheckUpdateResult;
...
public class GuessNumGame extends BaseGameActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.sign_in_button) {
            ...
            try {
                startActivity(Games.GamesMetadata.getGamePageIntent("com.arioclub.android", this));
            ...
            try {
                startActivity(Games.GamesMetadata.getDeveloperGamesIntent("13", this));
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
            }
        }
            ...
            try {
                startActivity(Games.GamesMetadata.getCommentOnGameIntent("com.arioclub.android", this));
            } catch (PackageManager.NameNotFoundException e) {
                e.printStackTrace();
            }
        }
            ...
            Games.Screenshot.postScreenShot(getApiClient(), bitmap, "یه بازی خوب و سرگرم کننده");
        }
    ...
    public void btnPressed(View v){
        ...
        if(btn<0){
            ...
            if(btn==number){
                ...
                info.setText("درسته! جواب  "+number+" بود");
                ...
                info.setText("نه! جواب  "+number+" بود");
                disableNumbers();
            }
            else {
                info.setTextColor(Color.GRAY);
                info.setText("اشتباهه، یه عدد دیگه حدس بزن!");
            }
        }
    }
