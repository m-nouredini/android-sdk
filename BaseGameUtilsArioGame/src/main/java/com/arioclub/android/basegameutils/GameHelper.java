...
public class GameHelper implements ArioGameApiClient.ConnectionCallbacks,
...
//    ArrayList<GameRequest> mRequests;
     ...
     * setup().
     */
    public void setPlusApiOptions(int options) {
    ...
    public ArioGameApiClient.Builder createApiClientBuilder() {
        ...
        ArioGameApiClient.Builder builder = new ArioGameApiClient.Builder(
                mActivity, this, this);
