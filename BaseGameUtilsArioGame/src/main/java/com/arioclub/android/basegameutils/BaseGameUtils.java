...
import com.arioclub.android.sdk.common.api.ArioGameServiceUtil;
import com.arioclub.android.sdk.games.GamesActivityResultCodes;
...
public class BaseGameUtils {
     ...
     * {@link ArioGameApiClient.OnConnectionFailedListener#onConnectionFailed(ConnectionResult)}
     *
    ...
    public static boolean resolveConnectionFailure(Activity activity,
                                                   ArioGameApiClient client, ConnectionResult result, int requestCode,
        ...
        if (result.hasResolution()) {
            ...
            Dialog dialog = ArioGameServiceUtil.getErrorDialog(errorCode,
